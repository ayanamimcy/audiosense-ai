...
/**
 * Compute MD5 of a file in chunks (non-blocking via setTimeout batching).
 */
...
/**
 * Upload a single chunk with XHR for progress tracking.
 */
...
/**
 * Perform a chunked upload for a large file.
...
export async function chunkedUpload(
  ...
  // If the server already merged this file (resume after lost response), return immediately
  ...
  // Concurrency pool using Promise.race
...
/**
 * Upload a small file with XHR progress tracking.
 * Returns the taskId on success.
 */
