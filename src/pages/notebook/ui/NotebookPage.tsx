            ...
            {activeTask ? (
              <TaskDetail
                ...
                onDeleteTask={async () => {
                  ...
                  // Use replace so the deleted task URL doesn't linger in history.
                  // Otherwise pressing Back would re-trigger the useEffect that fetches
                  // the deleted id and strand the user on a 404 "Unavailable" view.
                  navigate('/notebook', { replace: true });
                  await fetchTasks();
                  await fetchTags();
                }}
